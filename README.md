...
- **`format=tvbox`** - TVBox JSON
- **`format=tvbox-base58`** - TVBox Base58
...
| `format` | 配置模式         | `format=0 或 raw - 原始 JSON` <br> `format=1 或 proxy - 添加代理前缀` <br> `format=2 或 base58 - 原始 Base58` <br> `format=3 或 proxy-base58 - 代理 Base58` <br> `format=tvbox - TVBox JSON` <br> `format=tvbox-base58 - TVBox Base58` | `?format=0` |
...
## API 状态（最近更新：2026-04-28 02:11 CST）
...
| ✅ | 🔞优优资源 | [Link](https://www.yytv4.cc) | [Link](https://www.yytv4.cc/api.php/provide/vod) | ✅ | 3 | 0 | 100.0% | ----✅✅✅ |
